...
SPECIES: list[dict] = [
{
    ...
    },
    {
        ...
        "classifier_description": (
            ...
            "blocky, and heavily armored, covered in sharp bony ridges and small fleshy skin tabs (like "
            "tiny flaps of skin sticking out, especially around the eyes and mouth). The body pattern "
            "is a mottled, blotchy red, orange, and brown camouflage wash — uneven patches, NOT small "
            "uniform round dots. IMPORTANT — DO NOT use a raised/spiky dorsal fin alone as Sculpin "
            "evidence: Sculpin's dorsal spines are genuinely thick and heavy, but Paralabrax bass "
            "(Spotted Bay Bass, Barred Sand Bass, Calico Bass) all also have a spiky erect anterior "
            "dorsal fin when handled — a spiky-looking fin on its own does NOT mean Sculpin. The "
            "diagnostic spines/ridges are on the HEAD (bony ridges, fleshy tabs near eyes/mouth), not "
            "the dorsal fin. Likewise, DO NOT weight overall body color/tone (red/orange/brown vs. "
            "grey/olive) as decisive on its own — a brownish or tan bass is still a bass; color varies "
            "with habitat and lighting. DECISION RULE: a spotted-looking or brownish fish is NOT "
            "automatically a Sculpin, and a spiky dorsal fin is NOT automatically a Sculpin either — "
            "only call Sculpin if the HEAD shows bony ridges or fleshy tabs, OR the body pattern is an "
            "uneven blotchy wash rather than small uniform evenly-spaced dots. COMMONLY CONFUSED WITH: "
            "Spotted Bay Bass. DIFFERENTIATION: Sculpin has a big rough armored HEAD with bony ridges "
            "and fleshy tabs, a chunky asymmetric build, and blotchy camouflage coloring. Spotted Bay "
            "Bass has smooth skin, a small sleek unarmored head, no head spines or skin tabs, and small "
            "uniform round polka-dot freckles instead of blotchy camouflage — even though it also has "
            "a spiky dorsal fin and can appear brownish. Judge by head armor and dot geometry only, "
            "never by fin spikiness or overall color."
        ),
    },
    {
