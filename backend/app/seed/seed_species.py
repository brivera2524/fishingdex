...
SPECIES: list[dict] = [
{
        ...
        "classifier_description": (
            ...
            "accordingly. COMMONLY CONFUSED WITH: Barred Sand Bass (which is comparatively CLEAN and "
            "unfreckled everywhere, not just the face — check the whole body for freckling, not just "
            "the bars, to tell them apart) and Sculpin (rough, spiny, armored head with blotchy "
            "camouflage instead of small uniform round dots — check skin texture and head armor, not "
            "just 'has spots')."
        ),
    },
    {
